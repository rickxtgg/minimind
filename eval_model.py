# MiniMind模型评估脚本
# 本脚本用于评估不同阶段(预训练、SFT、RLHF、推理)模型的性能
# 主要功能：
# 1. 支持多种模型加载方式：原生PyTorch权重和Transformers格式
# 2. 支持不同模型架构：基础模型、MoE模型和LoRA微调模型
# 3. 提供自动测试和手动输入两种评估模式
# 4. 实现了流式输出和多轮对话能力
